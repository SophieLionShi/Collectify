...
class Menu {
	...
	public function membership_admin_notice_error() {
		...
		/* translators: %s: url */
		$message = sprintf( __( 'Collectify has detected that user registrations are disabled on this website. Please make sure that %s is enabled.', 'collectify' ), wp_kses_post( $setting_anchor ) );
	...
	public function plugin_action_links( $links ) {
		array_unshift( $links, '<a href="' . admin_url( 'options-general.php?page=collectify' ) . '">' . __( 'Settings', 'collectify' ) . '</a>' );
