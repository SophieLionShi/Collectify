...
<div class="checkout-button-container <?php echo $blurred_image_activated ? esc_attr( 'blurred' ) : ''; ?>">
	 ...
	 */
	?>
	<a target="_blank" href='<?php echo $checkout_url; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>' class="checkout-button"><?php echo esc_html( $checkout_button_text ); ?></a>
</div>
